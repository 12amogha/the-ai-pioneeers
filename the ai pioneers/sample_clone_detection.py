...
if(b == 100 or mean>71.6 ):
  ...
  db.child("Fraud_Details").child(i).child("mean").set(mean/100)
  db.child("Fraud_Details").child(i).child("g").set(g)
  db.child("Fraud_Details").child(i).child("cat").set("")
  i+=1
